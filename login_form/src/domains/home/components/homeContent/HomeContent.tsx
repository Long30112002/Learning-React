        ...
        <div className="home-content">
            ...
            {isLoggedIn && user && (
                <div className="welcome-card">
                    ...
                    {/* Sửa Welcome Actions để dùng currentWorkspace */}
                    <div className="welcome-actions">
                        <Link
                            to={currentWorkspace ? `/workspace/${currentWorkspace.id}/dashboard` : '/dashboard'}
                            className="welcome-action-card primary"
                        >
                            <div className="action-icon">🚀</div>
                            <div className="action-content">
                                <div className="action-title">
                                    {currentWorkspace ? `Go to ${currentWorkspace.name}` : 'Go to Dashboard'}
                                </div>
